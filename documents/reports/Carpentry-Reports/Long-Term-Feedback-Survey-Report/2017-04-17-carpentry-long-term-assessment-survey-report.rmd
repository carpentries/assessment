...
ggplot(data_country_tally,
   ...
   #I tried using the line below to addd frequency count labels to     # the bars, but it isn't working.
   #geom_text(stat='', aes(label=..count..), vjust=-1)
   theme_classic() +
   xlab("Country") +
   ylab("% Respondents") +
   coord_flip() +
...
kable(data_position_other_tally)
```
...
kable(data_workshops_tally, format = "markdown", row.names = FALSE, col.names = c("Count", "n"), caption = "Number of Workshops Attended")
```
