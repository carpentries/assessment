...
#kable(data_howlong_tally, format = "markdown", row.names = FALSE, col.names = c("Time", "n"), caption = "How Long Ago Did Respondents Complete a Workshop?")
...
data %>%
  ...
  geom_text(aes(label=n), size= 4) +
    ...
    ggtitle("Respondents' Programming Usage Increased Post Workshop") +
    theme(plot.title = element_text(hjust = 0.5)) +
    theme_classic(base_size = 14)
```
