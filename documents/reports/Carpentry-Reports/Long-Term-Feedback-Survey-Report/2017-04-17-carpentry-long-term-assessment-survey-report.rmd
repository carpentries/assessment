...
#First get percentage of total for each category
kable(data_usage_tally)

percentage = c(("I have not been using tools like these.", "Less than once per year.", "Several times per year.", "Monthly.", "Weekly.", "Daily.") 'Total Count' = c(22, 18, 61, 48, 96, 188), check.names = FALSE))

# data %>% 
#  mutate(Percent = data$Programming.Usage.Since.Workshop / sum(data$Programming.Usage.Since.Workshop))

# df$percent<- prop.table(df$Programming.Usage.Since.Workshop)
# df

# ggplot(data, aes(fill=condition, y=value, x=data_usage_tally)) + 
