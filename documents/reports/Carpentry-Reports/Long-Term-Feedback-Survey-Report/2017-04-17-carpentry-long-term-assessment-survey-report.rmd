...
This analysis includes 510 responses. Not all respondents answered each of the 26 questions.
...
kable(data_position_other_tally, format = "markdown", row.names = FALSE, col.names = c("Position", "# Respondents"))
```
Nearly 75% of respondents participated in a Carpentry workshop more than one year ago, and the majority of respondents have attended only one Carpentry workshop. 
...
The majority of respondents attending a workshop more than one year ago speaks to their level of involvement with the Carpentries (`r Carpentry_Involvement[1,2]` responded having subscribed to the Carpentries newsletter). It can be difficult, in survey research, to collect responses from participants a year later. It is great to see that learners are still receptive to our e-mail communication and have taken time to complete our survey.
