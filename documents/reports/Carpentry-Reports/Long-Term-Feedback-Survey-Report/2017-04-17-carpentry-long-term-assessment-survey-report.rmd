...
Software Carpentry's [lessons](https://software-carpentry.org) include the Unix Shell, version control with Git and Mercurial, programming with Python, R, and MATLAB, databases with SQL, Automation and Make, and Instructor Training. The long-term feedback survey did not include questions for learners who participated in instructor training.
```{r}
...
## Recommending Carpentry Workshops?
