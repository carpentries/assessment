...
learning_levels = c("Used non-Carpentry self-guided material.", 
...
#Learning <- (round(prop.table(table(n)))) * 100
                  
#my.prop <- prop.table(table(n/sum(n))) * 100
#kable(learning_levels, my.prop, format = "markdown", row.names = FALSE, col.names = c("Continuous Learning", "%"))
