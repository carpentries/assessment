...
```
# Highlights
Provided below are a few higlights from our data.
...
+ `r Made_Analyses_Reproducible[1] + Made_Analyses_Reproducible[4]`% of our respondents have made their analyses more reprodicible as a result of completing a Carpentry workshop.
