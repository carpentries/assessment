...
*__Instructors.Considerate_: Instructors were considerate.           
...
data_often <- map_if(data_often, 
                     is.character, 
                     as.factor)
title <- "Learner Perception of Workshop Instructors and Helpers"
...
## Learner Self-Perception of Knowledge of Tools Covered
...
```
Though some learners had knowledge of the tools covered in their workshop, an overwhelming majority had little to no knowledge of the topics covered.

A more in-depth look at learner's prior knowledge is provided below.
```{r}
cols_with_Little <- map_lgl(data, ~`%in%`("Little or no knowledge of topic", .x))
data_little <-  data[ , cols_with_Little]
