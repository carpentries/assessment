...
library(forcats)
```
This report is an analysis of the post-workshop survey responses collected for Data Carpentry's workshops from XX through XX. In this XX year period, nearly XX responses were collected.

A [PDF](https://github.com/carpentries/public-survey-info/blob/master/documents/surveys/dc_presurvey_archived.pdf) of the survey questions, the data used in this analysis, and full R code are located on the [public-survey-info](https://github.com/carpentries/public-survey-info) repo on GitHub. I'd like to thank Ben Marwick, Naupaka Zimmerman, Erin Becker, and Jonah Duckles for their valuable contributions to the code that was used to create the figures in this report.
...
```{r include=FALSE}
data <- readr::read_csv("https://raw.githubusercontent.com/carpentries/public-survey-info/master/documents/reports/Data-Carpentry-Reports/postworkshop_data.csv")
```
