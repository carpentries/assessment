...
SWC workshops teach automation with the Unix shell, a very traditional and fundamental tool. It lets the users interact with the computer at a base level, by running commands interactively or by scripting. In SWC workshops, we teach version control of source code with Git. We also teach GitHub, a popular Git-based web service for hosting code repositories and facilitating contribution and collaboration. We do warn learners that their research institutions might recommend or require them to use other hosting platforms.
```{r}
# Why are you attending this workshop?
