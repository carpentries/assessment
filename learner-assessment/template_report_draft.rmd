...
ggplot(data_new_information_tally, 
  ...
  ylab("% Respondents") +
  ggtitle(paste(perc_learned_new_info,
...
# How do I de-select the variables that start with Instructors?
```
...
kable(dcpredata_race_tally, format = 'markdown', row.names = NA, col.names = c ("Data Carpentry's Respondents Racial/Ethnic Identity", "n", "%"))
```
