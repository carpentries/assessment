...
atmosphere_levels <- c("Strongly Disagree", "Disagree",
                       ...
                       "Didn't answer")
atmosphere_levels_match <- replace(atmosphere_levels, atmosphere_levels == "Neither Agree nor Disagree", "Neutral")
...
swc_comfortable <- swcpostdata %>%
    ...
    mutate(atmosphere = replace(atmosphere, atmosphere == "Neither Agree nor Disagree", "Neutral"))
