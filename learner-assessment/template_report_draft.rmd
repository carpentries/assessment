...
### Authors: [Kari L. Jordan](https://twitter.com/drkariljordan), [François Michonneau](https://twitter.com/fmic_), [Belinda Weaver](https://twitter.com/cloudaus)
...
=======
The two Likert plots below provide an analysis of respondents' answers for both instructors and helpers.
>>>>>>> 648a0f356003221b253af41a4db6fd8e6b2ad7c3
...
=======
The Carpentries is a global community that has recognized the importance of bringing people to data through high-impact trainings. Though the majority of Data Carpentry respondents attended a workshop in the United States of America (`r get_dc_country_percent("United States of America")`%), we see an increase in workshops in places such as Ethiopia (`r get_dc_country_percent("Ethiopia")`%), Switzerland (`r get_dc_country_percent("Switzerland")`%), and India (`r get_dc_country_percent("India")`%).   
>>>>>>> 648a0f356003221b253af41a4db6fd8e6b2ad7c3
...
Currently, both Data (XX%) Carpentry and Software (XX%) Carpentry see strong representation from women in the United States. Where we hope to improve is in reaching the non-White audience, as fewer than XX% of our respondents are from communities historically underrepresented in the science, technology, engineering, and mathematics (STEM) fields.
...
Currently, Data Carpentry and Software Carpentry use different surveys. In the coming months, we plan to develop one common survey to be used for both Data Carpentry and Software Carpentry.
