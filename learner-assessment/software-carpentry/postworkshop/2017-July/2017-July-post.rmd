...
```{r include=FALSE}
data <- readr::read_csv("https://raw.githubusercontent.com/carpentries/assessment/master/learner-assessment/software-carpentry/postworkshop/2017-July/data.csv")
```
