...
output:
  html_document:
    self_contained: true   ## <--- change this
    toc: true
    toc_float: true
...
### - [ ] re-export data to remove network_id, consent, over_18, start_ and
###   end__datetime
...
We released our latest long-term survey results in April 2020. You can find [the report](https://github.com/carpentries/assessment/blob/master/learner-assessment/reports/2020-01-long-term-report.pdf) and [its source](https://github.com/carpentries/assessment/blob/master/learner-assessment/reports-src/2020-01-long-term-survey.Rmd) in the [assessment GitHub repository](https://github.com/carpentries/assessment/blob/master/learner-assessment/).

The results included in this report only cover the data collected in 2020 (between September 28th, 2020 and November 1st, 2020). This report includes the analysis of `r nrow(lt_data)` responses but most questions are optional and specific questions have less answers.
...
Long-term survey respondents reported that they were most likely to adopt _using version control to manage code_ followed by _Other_ behaviors. 
