...
dcpredata <- readr::read_csv("../data/20180816_dcpredata_memberorgs.csv",
                             col_types = cols(
                                 Date =  col_datetime(
                                     format = "%m/%d/%y %H:%M"
                                 ),
...
dcpostdata <- readr::read_csv("../data/20180816_dcpostdata_memberorgs.csv",
                              col_types = cols(
                                  Date =  col_datetime(
                                      format = "%m/%d/%y %H:%M"
                                  ),
...
swcpredata <- readr::read_csv("../data/20180816_swcpredata_memberorgs.csv",
                              col_types = cols(
                                  Date =  col_datetime(
                                      format = "%m/%d/%y %H:%M"
                                  ),
...
swcpostdata <- readr::read_csv("../data/20180816_swcpostdata_memberorgs.csv",
                               col_types = cols(
                                   Date =  col_datetime(
                                       format = "%m/%d/%y %H:%M"
                                   ),
