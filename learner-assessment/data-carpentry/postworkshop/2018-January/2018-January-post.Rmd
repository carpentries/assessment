...
Learners were asked how likely they are to recommend this workshop to a friend or colleague using the [Net Promoter Score](https://en.wikipedia.org/wiki/Net_Promoter).
```{r}
# data %>% 
  #tally_and_perc(`Recommend`, na.rm = TRUE) %>% 
beeswarm(data$Recommend,
         method = c("center"),
         vertical = TRUE,
         pch = 16, col = rainbow(7))
# col picks the color, pch fills the circles in with the color
