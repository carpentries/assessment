...
```
```{r}
#Change from character to numerica
RawData.x <- revalue(data_merged$RawData.x, c("Strongly disagree" = "1",
                                      "Disagree" = "2",
                                      "Neutral" = "3",
                                      "Agree" = "4",
                                      "Strongly agree" = "5"))

RawData.y <- revalue(data_merged$RawData.y, c("Strongly disagree" = "1",
                                      "Disagree" = "2",
                                      "Neutral" = "3",
                                      "Agree" = "4",
                                      "Strongly agree" = "5"))
...
```{r}
data <-data.frame(RawData.x, RawData.y)
# Paired t-test
t.test(data ~ group, sleep, paired=TRUE)
```
