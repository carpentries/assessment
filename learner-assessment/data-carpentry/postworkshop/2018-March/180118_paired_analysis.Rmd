...
```{r echo=FALSE}
predata <- read.csv("https://raw.githubusercontent.com/carpentries/private-data/master/learner-assessment/data-carpentry/180118_dcpre.csv?token=AUDcFxfA1eiClziBxiHMfK1KkI5CPTC3ks5asDC6wA%3D%3D", stringsAsFactors = FALSE)
postdata <- read.csv("https://raw.githubusercontent.com/carpentries/private-data/master/learner-assessment/data-carpentry/180108_dcpost.csv?token=AUDcF3z7OolTxfuvJ21GiV5YOSZ5J0u3ks5asDBSwA%3D%3D", stringsAsFactors = FALSE)
```
