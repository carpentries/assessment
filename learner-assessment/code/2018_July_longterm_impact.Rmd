...
A special thanks goes out to [François Michonneau](https://twitter.com/fmic_) and others who helped write the code used in this report.
...
+ Respondents' Gender and Racial/Ethnic Identity
...
Learners were asked to check all that applies to indicate what content was covered at the last Carpentries workshop they completed.
...
Compared to before completing a Carpentries workshop, we want to know how often respondents used programming languages (R, Python, etc.), databases (Access, SQL, etc.), version control software and/or the shell.
...
Since completing a Carpentries workshop, we asked how often respondents currently use programming languages (R, Python, etc.), databases (Access, SQL, etc.), version control software and/or the shell.
...
Below we comparing pre/post programming usage.
...
# Workshop Impact
The statements below reflect ways in which completing a Carpentries wtheir level of agreement with these statements:
...
We are interested in understanding what impact our workshops have on respondents long-term. This section includes the following:
...
## Change in Confidence
We asked respondents to rate their change in confidence in the tools that were covered during their Carpentries workshops compared to before the workshop.
