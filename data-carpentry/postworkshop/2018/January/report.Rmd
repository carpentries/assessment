...
library(srvyr)
```
A [PDF](https://github.com/carpentries/assessment/blob/master/surveys/dc_postsurvey_INUSE.pdf) of the survey questions, the data used in this analysis, and full R code are located on the Data Carpentry [assessment](https://github.com/carpentries/assessment/tree/master/data-carpentry/postworkshop/2018/January) repo on GitHub. Feel free to use the data and [tell us](mailto: kariljordan@carpentries.org) about your findings.
