...
## Tables and Figures for 2018 ASEE Paper
...
__Is this your first time completing this survey?__

This question was added to the survey in the second round of data collection, that's why the n is so small. Do not include this in the paper.
```{r}
...
ggplot(round2data_status_tally,
  ...
  theme_classic() +
  xlab("Figure X: Respondents' Status") +
  ylab("% Respondents") +
  ggtitle("") +
...
ggplot(round2data_workshops_tally,
  ...
  scale_x_discrete(labels = function(x) lapply(strwrap(x, width = 10, simplify = FALSE), paste, collapse="\n")) +
  theme_classic() +
  xlab("Figure 5: Number of Workshops Attended") +
  ylab("% Respondents") +
  ggtitle("") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme_classic(base_size = 14)
...
ggplot(round2data_time_since_tally,
  ...
  scale_x_discrete(labels = function(x) lapply(strwrap(x, width = 10, simplify = FALSE), paste, collapse="\n")) +
  theme_classic() +
  xlab("Figure X: Time Since Attending Carpentry Workshop") +
  ylab("% Respondents") +
  ggtitle("") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme_classic(base_size = 14)
...
__Last Carpentries workshop attended__

This question was added to the survey during the second round, so there are only 17 responses. Do not include this in the paper.
```{r}
...
round2data %>%
  ...
  ggplot(pre_and_post_usage,
    ...
    scale_x_discrete(labels = function(x) lapply(strwrap(x,
                                                 ...
                                                 collapse = "\n")) +
    theme_classic() +
    xlab("Figure 6: Respondents' Programming Usage Increased") +
    ylab("% Respondents") +
...
ggplot(pre_and_post_usage_by_group,
  ...
  scale_x_discrete(labels = function(x) lapply(strwrap(x,
                                               ...
                                               collapse = "\n")) +
  theme_classic() +
  xlab("Figure XX: Respondents' Programming Usage Increased (Grouped)") +
...
ggplot(stdres,
  ...
  xlab("Figure X: Respondents program significantly more often") +
...
title <- "Table X: Perception of Workshop Impact"
