...
We are interested to know how much of the information presented at Carpentries instructor training events is new. 
...
Trainees were asked to rate their level of agreement about the following:
...
Trainees were asked to  balance of lecture to hands-on work?__
...
Trainees were asked how likely they are to recommend a Software and/or Data Carpentry workshop to a friend or colleague using the [Net Promoter Score](https://en.wikipedia.org/wiki/Net_Promoter). The scoring for this question based on a 0 to 10 scale. Trainees scoring from 0 to 6 are labeled *Detractors*, and are believed to be less likely to recommend a workshop. Those who respond with a score of 9 to 10 are called *Promoters*, and are considered likely to recommend a workshop. Trainees between 7 and 8 are labeled *Passives*, and their behavior falls in the middle of Promoters and Detractors.
