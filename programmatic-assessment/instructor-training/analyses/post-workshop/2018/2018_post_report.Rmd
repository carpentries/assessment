...
In the interest of improving diversity, we collect additional demographic information for U.S. participants. This information is completely voluntary. Trainees were asked to self-report how they identify themselves by selecting among various racial/ethnic groups and to describe their gender identity.
...
kable(npr,format = 'markdown', colnames = c("Net Promoter Score", "n", "%"))
```
